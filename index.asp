...
<head>
	<style type="text/css">
	    #linkHolder a{color:#4985c7 !important;text-decoration:none;}
        #linkHolder a:visited{color:#4985c7 !important;text-decoration:none;}
        #linkHolder a:hover{color:#cc6600 !important;text-decoration:underline;}
	</style>
	...
	<script language="javascript" type="text/javascript">
        ...
        var pin1 = new Object();
        pin1.locid = "274";
        pin1.region = "Latin America";
        pin1.site = "Historic Sanctuary of Machu Picchu";
        pin1.location = "Left bank of the Vilcanota river, between its tributaries the Kusichaca and Aobamba rivers, in the department of Cuzco, Urubamba Province, District of Macchu Picchu";
        pin1.state = "Peru";
        pin1.desc = "Machu Picchu stands 2,430 m above sea-level, in the middle of a tropical mountain forest, in an extraordinarily beautiful setting. It was probably the most amazing urban creation of the Inca Empire at its height; its giant walls, terraces and ramps seem as if they have been cut naturally in the continuous rock escarpments. The natural setting, on the eastern slopes of the Andes, encompasses the upper Amazon basin with its rich diversity of flora and fauna.";
        pin1.img = "http://whc.unesco.org/uploads/sites/site_274.jpg";
        pin1.lat = "-13.11666667";
        pin1.lng = "-72.58333333";
        ...
        var pin2 = new Object();
        pin2.locid = "307";
        pin2.region = "North America";
        pin2.site = "Statue of Liberty";
        pin2.location = "New York, New York";
        pin2.state = "United States of America";
        pin2.desc = "Made in Paris by the French sculptor Bartholdi, in collaboration with Gustave Eiffel (who was responsible for the steel framework), this towering monument to liberty was a gift from France on the centenary of American independence in 1886. Standing at the entrance to New York Harbour, it has welcomed millions of immigrants to the United States ever since.";
        pin2.img = "http://whc.unesco.org/uploads/sites/site_307.jpg";
        pin2.lat = "40.68944444";
        pin2.lng = "-74.04472222";
        ...
        function BuildPushpin(locid,region,site,location,state,desc,img,lat,lng,customIcon)
        {
	        ...
	        var description = "<div style='margin-left:0;'><table border='0' cellpadding='0' cellspacing='0'><tr><td align='right' valign='top' style='padding-right:0px; padding-top:10px;'><img src='" + img + "' style='border: solid 1px #c0c0c1; padding:1px 1px 1px 1px; background-color:#ffffff;' align='left' width='88'></td><td align='left' valign='top' style='font-family:arial; font-size:11; color:#333333; padding-left:6px; padding-top:7px; text-align:left;'><a href='javascript:this.map.HideInfoBox();'><img src='http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_close.gif' align='right' style='margin-left:3px;' id='close'></a><a href='sites.asp?region="+region+"&locid="+locid+"' class='infoBoxLinkOff' onmouseover='this.className=\"infoBoxLinkOn\";' onmouseout='this.className=\"infoBoxLinkOff\";'>" + site + "</a><div style='margin-top:3px;margin-bottom:3px;'>"+ truncateLoc(location) +"<br /><div style='margin-top:2px;'>"+ state +"</div></div>" + truncate(desc,region,locid) + "<br /><br /><a href='sites.asp?region="+region+"&locid="+locid+"'><img src='http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_landing_arrow.gif' style='border:none;padding-right:2px;'></a> <a href='sites.asp?region="+region+"&locid="+locid+"' class='sitepageLinkOff' onmouseover='this.className=\"sitepageLinkOn\";' onmouseout='this.className=\"sitepageLinkOff\";' style='vertical-align:top;'>Explore this site</a></td></tr></table></div>";
	        if (navigator.userAgent.indexOf("Firefox") != -1)
	        {
	            var description = "<div style='margin-left:0;'><table border='0' cellpadding='0' cellspacing='0'><tr><td align='right' valign='top' style='padding-top:10px;'><img src='" + img + "' style='border: solid 1px #c0c0c1; padding:1px 1px 1px 1px; background-color:#ffffff;' align='left' width='88'></td><td align='left' valign='top' style='font-family:arial; font-size:11px; color:#333333; padding-left:6px; padding-top:7px; padding-right:8px; text-align:left;'><a href='javascript:this.map.HideInfoBox();'><img src='http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_close.gif' align='right' style='margin-left:3px;padding-right:6px;'></a><a href='sites.asp?region="+region+"&locid="+locid+"' class='infoBoxLinkOff' onmouseover='this.className=\"infoBoxLinkOn\";' onmouseout='this.className=\"infoBoxLinkOff\";'>" + site + "</a><div style='margin-top:3px;margin-bottom:3px;'>"+ truncateLoc(location) +"<br /><div style='margin-top:2px;'>"+ state +"</div></div>" + truncate(desc,region,locid) + "<br /><br /><a href='sites.asp?region="+region+"&locid="+locid+"'><img src='http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_landing_arrow.gif' style='border:none;padding-right:2px;'></a> <a href='sites.asp?region="+region+"&locid="+locid+"' class='sitepageLinkOff' onmouseover='this.className=\"sitepageLinkOn\";' onmouseout='this.className=\"sitepageLinkOff\";' style='vertical-align:top;'>Explore this site</a></td></tr></table></div>";
	        }
	        if (navigator.userAgent.indexOf("MSIE 7") != -1)
            {
                var description = "<div style='margin-left:0;'><table border='0' cellpadding='0' cellspacing='0'><tr><td align='right' valign='top' style='padding-right:0px; padding-top:10px;'><img src='" + img + "' style='border: solid 1px #c0c0c1; padding:1px 1px 1px 1px; background-color:#ffffff;' align='left' width='88'></td><td align='left' valign='top' style='font-family:arial; font-size:11px; color:#333333; padding-left:6px; padding-top:7px; text-align:left;'><a href='javascript:this.map.HideInfoBox();'><img src='http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_close.gif' align='right' style='margin-left:3px;padding-right:6px;'></a><a href='sites.asp?region="+region+"&locid="+locid+"' class='infoBoxLinkOff' onmouseover='this.className=\"infoBoxLinkOn\";' onmouseout='this.className=\"infoBoxLinkOff\";'>" + site + "</a><div style='margin-top:3px;margin-bottom:3px;'>"+ truncateLoc(location) +"<br /><div style='margin-top:2px;'>"+ state +"</div></div>" + truncate(desc,region,locid) + "<br /><br /><a href='sites.asp?region="+region+"&locid="+locid+"'><img src='http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_landing_arrow.gif' style='border:none;padding-right:2px;'></a> <a href='sites.asp?region="+region+"&locid="+locid+"' class='sitepageLinkOff' onmouseover='this.className=\"sitepageLinkOn\";' onmouseout='this.className=\"sitepageLinkOff\";' style='vertical-align:top;'>Explore this site</a></td></tr></table></div>";
            }
        ...
        function buildLinks(locid,region,site,location,state,desc)
        {
            ...
            myArrow.src = "http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_arrow-sm.gif";
            var myArrowOn = new Image();
            myArrowOn.src = "wh_arrow-sm_on.gif";
            ...
            featureLink1.style.cssText = "font-family: arial, helvetica, sans serif;font-size: 11px;font-weight:normal;cursor:pointer;";
            ...
            holdingCell.appendChild(spacer1);
            ...
            featureLink2.style.cssText = "font-family: arial, helvetica, sans serif;font-size: 11px;font-weight:normal;cursor:pointer;";
            var feature2_tn = document.createTextNode("Kazan Kremlin, Russian Federation");
            featureLink2.appendChild(feature2_tn);
            holdingCell.appendChild(featureLink2);
            holdingCell.appendChild(spacer2);
            ...
            featureLink3.style.cssText = "font-family: arial, helvetica, sans serif;font-size: 11px;font-weight:normal;cursor:pointer;";
            var feature3_tn = document.createTextNode("Tsodilo, Botswana");
            featureLink3.appendChild(feature3_tn);
            holdingCell.appendChild(featureLink3);
            holdingCell.appendChild(spacer3);
            ...
            featureLink4.style.cssText = "font-family: arial, helvetica, sans serif;font-size: 11px;font-weight:normal;cursor:pointer;";
            var feature4_tn = document.createTextNode("Temple of Heaven, China");
            featureLink4.appendChild(feature4_tn);
            holdingCell.appendChild(featureLink4);
            holdingCell.appendChild(spacer4);
            ...
            featureLink5.style.cssText = "font-family: arial, helvetica, sans serif;font-size: 11px;font-weight:normal;cursor:pointer;";
            var feature5_tn = document.createTextNode("Morne Trois Pitons, Dominica");
            featureLink5.appendChild(feature5_tn);
            holdingCell.appendChild(featureLink5);
            holdingCell.appendChild(spacer5);
            ...
            featureLink6.style.cssText = "font-family: arial, helvetica, sans serif;font-size: 11px;font-weight:normal;cursor:pointer;";
            var feature6_tn = document.createTextNode("Forest Complext, Thailand");
            featureLink6.appendChild(feature6_tn);
            holdingCell.appendChild(featureLink6);
            holdingCell.appendChild(spacer6);
            ...
            featureLink7.style.cssText = "font-family: arial, helvetica, sans serif;font-size: 11px;font-weight:normal;cursor:pointer;";
            var feature7_tn = document.createTextNode("Sydney Opera House, Australia");
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="418">
             ...
             <td>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="left" valign="top" style="color:#264466; font-size:14px; font-family:arial, helvetica, sans serif; font-weight:normal; padding-left:6px; padding-top:0px; vertical-align:top;">
        ...
        <tr>
            <td style="font-family:arial, helvetica, sans serif; font-size: 12px; padding-top:10px; padding-left:10px;">
                <img src="http://media.expedia.com/media/content/expus/graphics/promos/deals/wh_landing_arrow.gif" align="absmiddle" style="border:none;padding-right:2px;"> <a href="find.asp" onmouseover="this.className='sitepageLinkOn'" onmouseout="this.className='sitepageLinkOff'" class="sitepageLink">Find a World Heritage site</a>
            </td>
        </tr>
    </table>
<script language="javascript" type="text/javascript">
    if (navigator.userAgent.indexOf("MSIE 7") != -1)
    {
        document.getElementById("myMap").style.cssText = "position:relative;width:418px;height:214px;margin:1px 8px 8px 1px;";
    }
    if (navigator.userAgent.indexOf("Firefox") != -1)
    {
        document.getElementById("myMap").style.cssText = "position:relative;width:418px;height:214px;margin:1px 8px 8px 1px;";
